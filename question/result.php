...
<body style="background:#E1F0F7">
	<table width="795" border="0">
		...
		<tr class="tr2">
			<td width="400">项目名称</td><td width="100">创建时间</td><td width="250">操作</td>
		</tr>
		<? for($i=0;$i<$count;$i++){?>
		<tr class="tr3" id="<?php echo $record[$i]->id;?>">
			...
			<td>
				<a href="show.php?id=<?php echo $record[$i]->id;?>" style="color:#000000; text-decoration:none">查看具体结果</a>
				<a href="show2.php?id=<?php echo $record[$i]->id;?>" style="color:#000000; text-decoration:none">查看统计结果</a>
			</td>
		</tr>
		<?  }?>
	</table>
