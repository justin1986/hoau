<?php
	...
	$default_load = $_GET['load'] ? $_GET['load'] : "khfw{$id}.php";
	if($_REQUEST['newsid']){
		$default_load .= "?id={$_REQUEST['newsid']}";	}
	$a = array();
	if($_GET['province']){
		array_push($a, "province=" .$_GET['province']);
	}
	if($_GET['city']){
		array_push($a, "city=" .$_GET['city']);
	}
	if($_GET['wdbh']){
		array_push($a, "wdbh=" .urlencode($_GET['wdbh']));
	}
	if($_GET['wdid']){
...
<head>
	...
	<title>天地华宇-客户服务</title><meta name="Keywords" content="天地华宇,天地华宇物流,天地华宇物流查询,华宇,华宇物流,华宇物流查询,天地华宇俱乐部,华宇俱乐部"/><meta name="Description" content="天地华宇-中国公路快运领导者"/>
	<?php
		css_include_tag('khfw','tb');
		use_jquery();
...
<body>
	...
	<div id=ibody>
		...
		<div id=center>
			<div id=c_left>
				<div id=c_menu>
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="174px" height="360px">
				      <param name=movie value="/flash/left-khfw.swf">
				      <param name=quality value=high>
					  <param name="flashvars" value="showid=<?php echo $show_id;?>">
				      <param name="wmode" value="transparent">
				      <embed src="/flash/left-khfw.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" flashvars="showid=<?php echo $show_id;?>" width="174" height="360" wmode="transparent"></embed>
				    </object>
				</div>
				<div id="zxkf" style="margin-top:0px;"><a href="/khfw/?load=khfw2.php"><img src="/images/zxkf.gif"></a></div>
				<!--
				<div id=hd>
