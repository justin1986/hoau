...
<body>
<div class="breadcum"><a href="/" target="_parent">首页</a> > <a href="/khfw/" target="_parent">客户服务</a> > 整车</div>
	<div id="title">违禁品查询</div>
	<div id="list">
		<?php for($i=0;$i<count($record);$i++){
		?>
		<div class=list_line>
			<div class=title>
				<li><span title="<?php echo $record[$i]->description;?>"><?php echo $record[$i]->name;?></span></li>
			</div>
			<div class=time>
