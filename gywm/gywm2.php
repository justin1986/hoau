<?php
	...
	$db = get_db();
	$sql = "select t1.id,t1.title,t1.created_at,t1.news_content from hoau_news t1 join hoau_category t2 on t1.category_id=t2.id where 1=1 and t2.name='大事记' order by priority asc,created_at desc";
	$news = $db->query($sql);
