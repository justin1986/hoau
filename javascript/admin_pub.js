$(function(){
		...
		$(".revocation").click(function(){
			$.post("/pub/pub.post.php",{id:$(this).attr('name'),'db_table':$('#db_table').attr('value'),type:"revocation",'is_dept_list':$('#is_dept_list').attr('value')},function(data){
				window.location.reload();
			});
		});
		
		$(".publish").click(function(){
			$.post("/pub/pub.post.php",{id:$(this).attr('name'),'db_table':$('#db_table').attr('value'),type:"publish",'is_dept_list':$('#is_dept_list').attr('value')},function(data){
				window.location.reload();
			});
		...
		$(".return").click(function(){
			...
			{
				$.post("/pub/pub.post.php",{'return_id':$(this).attr('name'),'db_table':$('#db_talbe').attr('value'),'post_type':'return'},function(data){					
					$("#"+data).remove();
				});
			}
		});
