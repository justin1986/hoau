...
<head>
	...
	<title>天地华宇-投资于人</title><meta name="Keywords" content="天地华宇,天地华宇物流,天地华宇物流查询,华宇,华宇物流,华宇物流查询,天地华宇俱乐部,华宇俱乐部"/><meta name="Description" content="天地华宇-中国公路快运领导者"/>
	<?php
		css_include_tag('rczp','tb');
		use_jquery();
...
<body>
	...
	<div id=ibody>
		...
		<div id=center>
			<div id=c_left>
				<div id=c_menu>
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="174px" height="238px">
				      <param name=movie value="/flash/left-rczp.swf">
				      <param name=quality value=high>
					  <param name="flashvars" value="showid=<?php echo $show_id;?>">
				      <param name="wmode" value="transparent">
				      <embed src="/flash/left-rczp.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" flashvars="showid=<?php echo $show_id;?>" width="174" height="238" wmode="transparent"></embed>
				    </object>
				</div>
			...
			<div id=c_right>
				<div id=drd_pic></div>
				<div id=iframe>
					<iframe id=drd_iframe name="drd_iframe" scrolling="no" frameborder="0" src="rczp<?php echo $id;?>.php" width="100%" height="550px"></iframe>
				</div>
			</div>
		</div>
