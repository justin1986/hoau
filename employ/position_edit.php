...
<body>
	...
	<form id="menu_form" method="post" action="position.post.php">
		...
		<tr class=tr3>
			<td width=150>职位名：</td>
			<td width=645 align="left"><input type="text" name="post[name]" value="<?php echo $position->name;?>" class="required"></td>
		</tr>
		<tr class=tr3>
			<td>优先级：</td>
			<td align="left"><input type="text" name="post[priority]"  value="<?php echo $position->priority;?>" class="required"></td>
		</tr>
		<tr class="normal_news tr3">
			<td height=265>职位介绍</td><td><?php show_fckeditor('post[jieshao]','Admin',true,"265",$position->jieshao);?></td>
		</tr>
		<tr class=tr3>
