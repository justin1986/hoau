<?php
	...
	$default_load = $_GET['load'] ? $_GET['load'] : "db{$id}.php";
...
<body>
	...
	<div id=ibody>
		...
		<div id=center>
			<div id=c_left>
				<div id=c_menu>
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="174px" height="366px">
				      <param name=movie value="/flash/left-bd.swf">
				      <param name=quality value=high>
					  <param name="flashvars" value="showid=<?php echo $show_id;?>">
				      <param name="wmode" value="transparent">
				      <embed src="/flash/left-bd.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" flashvars="showid=<?php echo $show_id;?>" type="application/x-shockwave-flash" width="174" height="366" wmode="transparent"></embed>
				    </object>
				</div>
